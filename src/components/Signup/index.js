...
class Signup extends React.Component {
  ...
  dripResponse = payload => {
    ...
    if (!payload.anonymous) {
      ...
      if (this.email && payload.email) this.email.value = payload.email
    ...
    if (this.state.loading) {
      return (
        <div className="signup">
          <p className="signedUp">Loading...</p>
        </div>
      )
    } else {
        ...
        return (
          <div className="signup">
            <p className="signedUp">
              You are signed up, we will email you the link to the event, the
              day of the talk.
            </p>
          </div>
        )
        ...
        return (
          <div className="signup">
            <form
              ...
              action="https://www.getdrip.com/forms/866148695/submissions"
              method="post"
              data-drip-embedded-form="866148695"
            >
              <h4>Tell me when and how to join</h4>
              <label id="drip-full-name-label" htmlFor="drip-full-name">
                Name
              </label>
              <input
                type="text"
              ...
              />
              <label id="drip-email-label" htmlFor="drip-email">
                Email Address
              </label>
              <input
                type="email"
                id="drip-email"
                placeholder="Jill@javascript.com"
                name="fields[email]"
